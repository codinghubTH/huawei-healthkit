...
class HealthKitDataControllerActivity : AppCompatActivity() {
    ...
    // Object of controller for fitness and com.codinghub.stayhome data, providing APIs for read/write, batch read/write, and listening
    ...
    fun readLatestData(view: View) {
        ...
        dataTypes.add(DataType.DT_INSTANTANEOUS_RESTING_HEART_RATE)

...
package com.codinghub.stayhome.auth
...
import com.codinghub.stayhome.R
...
class HealthKitAuthActivity : Activity() {
    ...
    // retry HUAWEI com.codinghub.stayhome authorization
    ...
    private fun requestAuth() {
        ...
        val scopes = arrayOf(
            ...
            Scopes.HEALTHKIT_OXYGENSTATURATION_READ, Scopes.HEALTHKIT_OXYGENSTATURATION_WRITE
        )

        // Obtains the authorization process Intent.
        // True indicates that the com.codinghub.stayhome app authorization process is enabled. False indicates disabled.

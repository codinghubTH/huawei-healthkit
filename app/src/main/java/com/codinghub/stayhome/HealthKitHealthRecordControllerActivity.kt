...
class HealthKitHealthRecordControllerActivity : AppCompatActivity() {
    ...
    /**
     * Add an com.codinghub.stayhome record to the Health platform
     *
    ...
    fun addHealthRecord(view: View) {
        ...
        // sampleSetList is used to store com.codinghub.stayhome details.
        ...
        // 3.Construct a com.codinghub.stayhome record collector (using the bradycardia com.codinghub.stayhome data type as an example) and construct a com.codinghub.stayhome record structure.
        ...
        // Set a value for each field of the bradycardia com.codinghub.stayhome data type.
        ...
        healthRecordController!!.addHealthRecord(insertOptions).addOnSuccessListener { healthRecordId ->
            ...
            logger("com.codinghub.stayhome record add was successful,please save the healthRecordId:\n$healthRecordId")
        }.addOnFailureListener { e -> printFailureMessage(e, "getHealthRecord") }
    }

    /**
     * updates com.codinghub.stayhome records of a specified HealthRecordID
     *
     * @param view indicating a UI object
     */
    ...
    /**
     * Read historical com.codinghub.stayhome records
     *
     * @param view indicating a UI object
     */
    fun getHealthRecord(view: View) {
        ...
        // Call the get method of the HealthRecordController to obtain com.codinghub.stayhome records
        ...
        task.addOnSuccessListener { readResponse ->
            ...
            // Print HealthRecord and corresponding com.codinghub.stayhome data in the result
            ...
            for (record in recordList) {
                ...
                logger("Print detailed data points associated with com.codinghub.stayhome records")
     ...
     *
     * @param healthRecord indicating a com.codinghub.stayhome record
     */
    private fun dumpHealthRecord(healthRecord: HealthRecord?) {
        logger("Print com.codinghub.stayhome record summary information!")
